...
use chrono::prelude::*;
struct Clocks {
    display_ht16k33: Option<mbta_countdown::ht16k33::ClockDisplay>,
    display_tm1637: Option<mbta_countdown::tm1637::ClockDisplay>,
}
...
impl Clocks {
    pub fn new(
        ...
        if clock_type == "HT16K33".to_string() {
            let clock_ht16k33 = mbta_countdown::ht16k33::ClockDisplay::new(
                address.unwrap(),
                clock_brightness,
            )?;
            Ok(Clocks {
            ...
            let clock_tm1637 = mbta_countdown::tm1637::ClockDisplay::new(clock_brightness)?;
            Ok(Clocks {
